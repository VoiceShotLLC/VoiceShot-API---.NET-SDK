   ...
   <script language="C#" runat=server>
	   ...
	   Boolean ParseXML(string XMLContent, ref string KeyPress)
	   {
		 try
		 {
		   ...
		   String MenuID, Duration, CallerID, CallID, VoiceFileName, PromptID, Action;
		   XmlNode TempNode;

		   StreamWriter w = File.AppendText(Request.MapPath("eventsoutcall.txt"));
	   ...
	   void Page_Load(object sender, System.EventArgs e)
	   {
		  try
		  {
			 ...
			 StreamWriter w = File.AppendText(Request.MapPath("xmleventsoutcall.txt"));
			 w.WriteLine("--- "  + DateTime.Now + " ------------------------------------------------------");

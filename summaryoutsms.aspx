   ...
   <script language="C#" runat=server>
	   ...
	   Boolean ParseXML(string XMLContent)
	   {
		 try
		 {
		   ...
		   String MenuID, Duration, CallerID, CallID, DateAndTime, PhoneNumber, Status, Comment;
		   Byte[] VoiceFile;
		   ...
		   StreamWriter w = File.AppendText(Request.MapPath("summaryoutsms.txt"));
		   ...
		   w.WriteLine("Date and Time: "    + DateAndTime);
	   ...
	   void Page_Load(object sender, System.EventArgs e)
	   {
		  try
		  {
			 ...
			 StreamWriter w = File.AppendText(Request.MapPath("xmlsummaryoutsms.txt"));
			 w.WriteLine("--- "  + DateTime.Now + " ------------------------------------------------------");
